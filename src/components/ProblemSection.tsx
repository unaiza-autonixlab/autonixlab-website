  ...
  return (
    <section className="py-24 px-6 relative">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="space-y-4 mb-12">
          {errors.map((err, i) => (
            <motion.div
              ...
              className="font-mono text-sm md:text-base bg-secondary/50 border border-border rounded-md p-4"
            >
        ...
        <a href="#case-studies" className="btn-outline-glow inline-block text-sm">
          [ Run Diagnostics ]
        </a>
      </div>
    </section>
